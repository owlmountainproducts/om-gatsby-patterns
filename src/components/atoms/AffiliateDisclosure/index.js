...
<section className="affiliate-disclosure-wrapper">
	...
	<div className="disclosure-body">
	  <h3 className="disclosure-title">Disclosure:</h3>
			<p className="disclosure-text">Some of the links in this post may be from our sponsors or advertising partners who we take great care to select.
			We’re letting you know because it’s the right thing to do.</p>
	</div>
</section>
);
